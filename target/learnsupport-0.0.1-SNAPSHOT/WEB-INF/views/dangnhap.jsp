...
<head>
    <title>Login</title>
    <meta charset="utf-8">
    <jsp:include page="header/headertrangchu.jsp"/>
</head>
<body id="bodySS">
<div class="container">
                        ...
                        <div class="col-md-12 control">
                            <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%">
                                <div>
                                    ...
                                    <button d="btn-sigin" style=" margin-left: 20px" type="button"
                                            class="btn btn-warning">
                                        <a href="dangky">Sign Up Here</a>
                                        <button style="margin-left: 20px" type="button" class="btn btn-danger"><a
                                                href="/learnsupport/">BACK</a></button>
                                    </button>
                                </div>
                            </div>
                        </div>
